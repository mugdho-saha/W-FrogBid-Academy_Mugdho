...
<div class="abouttabarea sp_top_100" id="art_program">
    <div class="container">
        <div class="row">
                    ...
                    <div class="registerarea__form">
                        ...
                        <form action="form_submit.php" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <input class="register__input" type="text" placeholder="ফোন নাম্বার *" name="phone"
                                           required>
                                </div>
                            </div>
    ...
    <!-- about__tap__section__start -->
    <div class="abouttabarea sp_top_100" id="coding_program">
        <div class="container">
            <div class="row">
                <div class="section__title text-center" data-aos="fade-up">
                    <div class="section__title__button">
