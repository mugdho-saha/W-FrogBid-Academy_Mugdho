...
<head>
    ...
    <title> হোম - ফ্রগপবিড একাডেমি </title>
...
<?php include('include/dark_light.php'); ?>
<!-- Dark/Light area end -->
...
<main class="main_wrapper overflow-hidden">
    ...
    <div class="herobannerarea herobannerarea__2 herobannerarea__kindergarten">
                                ...
                                <div class="herobannerarea__content__wraper">
                                    ...
                                    <div class="herobannerarea__title">
                                        <div class="herobannerarea__small__title">
                                            <span>একাডেমিক এক্সপার্টদের সাথে</span>
                                        </div>
                                        <div class="herobannerarea__title__heading__2 herobannerarea__title__heading__3">
                                            <h2>শিশুদের <span>স্কিল ডেভেলপমেন্ট</span> প্লাটফর্ম</h2>
                                        </div>
                                    </div>


                                    <div class="herobannerarea__text herobannerarea__text__2">
                                        <p>বাচ্চা এবং কিশোরদের জন্য সর্ব-প্রথম অফলাইন কোডিং ক্লাস<br>এবং আর্ট ও ক্রাফট
                                            একাডেমি</p>
                                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                    ...
                    <div class="aboutarea__content__wraper">
                        <div class="aboutarea__button">
                            <div class="default__small__button">আমাদের সম্পর্কে</div>
                        </div>
                        ...
                        <div class="aboutarea__para aboutarea__para__2">
                            <p>আপনার সন্তানকে ছোটবেলা থেকেই একাডেমিক শিক্ষার পাশাপাশি যদি সৃজনশীল কাজে সংযুক্ত করা যায়
                                তাহলে সে একজন মুক্তমনা মানুষ হিসেবে গড়ে ওঠে। শিশুদের কল্পনা শক্তিও প্রখর। তাই সৃজনশীল
                                কাজে তাদের আগ্রহও থাকে অনেক বেশি। ড্রয়িং , ক্রাফটিং, কোডিং প্ল্যাটফর্মে আপনার শিশুর
                                দক্ষতা উন্নয়নে ফ্রগবিড একাডেমি আছে আপনার সাথে, আধুনিক শিক্ষাকে আরও সহজ করতে।</p>
                        </div>
                        <div class="aboutarea__list__2">
                            <ul>
                                <li>
                                    <i class="icofont-check"></i> আনন্দের ছলে মানসম্মত শিক্ষা নিশ্চিত করাই আমাদের
                                    লক্ষ্য।
                                </li>

                                <li>
                                    <i class="icofont-check"></i> শিক্ষার্থীদের সৃজনশীল, মানসিক, প্রযুক্তিগত দক্ষতা
                                    বৃদ্ধি।
                                </li>

                                <li>
                                    <i class="icofont-check"></i> একাডেমিক ও ক্রিয়েটিভ শিক্ষার দক্ষতা উন্নয়নে গাইড
                                    লাইন।
                                </li>

                                <li>
                                    <i class="icofont-check"></i> বয়স ভিত্তিক ও মানসিকতা দক্ষতা অনুসারে ক্লাস বিভাজন।
                                </li>

                                <li>
                                    <i class="icofont-check"></i> স্কিল ডেভেলপমেন্টের মাধ্যমে আপনার বাচ্চাকে একধাপ
                                    এগিয়ে রাখা।
                                </li>
                            </ul>
                        </div>
    ...
    <div class="early__programs sp_bottom_100 sp_top_100">
        <div class="container">

            <div class="row">
                <div class="section__title text-center" data-aos="fade-up">
                    <div class="section__title__button">
                        <div class="default__small__button"> কোর্স</div>
                    </div>
                    <div class="section__title__heading heading__underline">
                        <h2>ছোটদের জন্য আমাদের<br> <span> কোর্স সমূহ </span>
                        </h2>
                    </div>
                </div>
            </div>
                            ...
                            <div class="single__service">
                                ...
                                <div class="service__small__img">
                                    <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M16.5961 10.265L19 1.33069L10.0022 3.73285L1 6.1306L7.59393 12.6627L14.1879 19.1992L16.5961 10.265Z"
        ...
        <div class="container">
            ...
            <div class="row row__custom__class">
                <div class="swiper featured__course">
                    <div class="swiper-wrapper flex align-items-center justify-content-center">
                            ...
                            <div class="gridarea__wraper">
                                ...
                                <div class="gridarea__content">
                                    <div class="gridarea__list">
                                        <ul>
                                            <li>
                                                <i class="icofont-book-alt"></i> সপ্তাহে ২ দিন
                                            </li>
                                            <li>
                ...
                <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                    <div class="registerarea__wraper">
                        <div class="section__title registerarea__section__title">
                            <div class="section__title__button">
                                <div class="default__small__button"> রেজিস্ট্রেশান</div>
                            </div>
                            <div class="section__title__heading heading__underline">
                            ...
                            <div class="gridarea__wraper">
                                ...
                                <div class="gridarea__content">
                                    <div class="gridarea__list">
                                        <ul>
                                            <li>
                                                <i class="icofont-book-alt"></i> ৪৮ টি ক্লাশ
                                            </li>
                                            <li>
                                                <i class="icofont-clock-time"></i> ১ঃ৩০ মিনিট
                                            </li>
                            ...
                            <div class="gridarea__wraper">
                                ...
                                <div class="gridarea__content">
                                    <div class="gridarea__list">
                                        <ul>
                                            <li>
                                                <i class="icofont-book-alt"></i> ৯৬ টি ক্লাশ
                                            </li>
                                            <li>
                                                <i class="icofont-clock-time"></i> ১ঃ৩০ মিনিট
                                            </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12 aos-init aos-animate" data-aos="fade-up">
                    <div class="section__title__2 text-center teamarea__margin">
                        <div class="section__small__title">
                            <span> নিউজ এন্ড ব্লগ</span>
                        </div>
                        <div class="section__title__heading__2 section__title__heading__3 heading__fontsize__2">
                            <h2>ফ্রগবিড একাডেমি নিউজ এন্ড ব্লগ </h2>
                        </div>
                    </div>
                </div>
            </div>
